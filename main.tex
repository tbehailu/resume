...
\school{University of California, Berkeley}{August 2011 - May 2015}{Bachelor of Arts - Computer Science}
...
\jobentry{Software Engineer}{Google, Mountain View, CA}{August 2015 - Present}{
SWE on the Android Partner Engineering Team.
}
...
% ICT Research
\research{Information Communications Technologies (ICT) Development for Sub-Saharan Farmers}{August 2014 - May 2015}{www.tsionbehailu.me/research}{Advisor: Prof. Tapan Parikh, School of Information}{Designing ICTs to Increase Smallholder Farmers' Access to Markets and Knowledge. Identify needs and defines opportunities through innovative ICT-based applications and systems which can increase agricultural small-holder productivity, profitability, and sustainability}{Funded by NSF, CRA-W, CDC}
...
\begin{body}
\vspace{-8pt}
\coursework{Databases}{Software Engineering}{Internet of Everyday Things (IoT)}{Internet Architecture}{Computer Security}{Artificial Intelligence}{Discrete Math \& Probability Theory}{Economic Theory--Micro}{Technology Entrepreneurship}{Finance}
{Data Structures (\emph{Java})}{Machine Learning}
\end{body}
...
\vspace{-8pt}
%%%%%%%%%%%%%%%%%% Activities %%%%%%%%%%%%%%%%%%%%%
\header{Awards \& Activities}

\begin{body}
\vspace{2pt}

\activitynorole{EECS Eugene L. Lawler Prize}{April 2015}{Awarded by the UC Berkeley EECS Student Awards Committee.}
...
\activitynolink{Undergraduate Study Committee}{L\&S Computer Science Representative}{September 2013 - May 2015}{ Aid in the making of departmental decisions with the Computer Science Department faculty and staff as a representative for Letters \& Science Computer Science students.}
